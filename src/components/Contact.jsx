    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up fire-text">
            💼 Let&apos;s Work Together
          </h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Ready to build something amazing? Contact me to discuss your project needs and start collaborating on innovative solutions!
          </p>
        ...
        <form
          action="https://getform.io/f/bollrnva"
          method="POST"
